...
// Determine base URL for navigation (always point to index.php for sections)
$nav_base = 'index.php';
?>
  ...
  <div class="container header-inner">
    ...
    <nav class="main-nav" aria-label="Main Navigation">
      <ul class="nav-list">
        ...
        <li><a href="<?php echo $nav_base; ?>#about" data-en="About" data-ar="من نحن">About</a></li>
        <li><a href="<?php echo $nav_base; ?>#services" data-en="Services" data-ar="خدماتنا">Services</a></li>
        <li><a href="<?php echo $nav_base; ?>#fleet" data-en="Fleet" data-ar="أسطولنا">Fleet</a></li>
        <li><a href="<?php echo $nav_base; ?>#projects" data-en="Projects" data-ar="مشاريعنا">Projects</a></li>
        <li><a href="<?php echo $nav_base; ?>#contact" data-en="Contact" data-ar="اتصل بنا">Contact</a></li>
